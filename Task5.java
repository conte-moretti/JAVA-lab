    ...
    public static void main (String[] args) throws IOException, NoSuchAlgorithmException {
        ...
        switch (n)
        {
            case (1):
                ...
                String out11 = encrypt(str2);
                int [] umas = new int[out11.length()];
                for (int j = 0; j < out11.length(); j++)
                    umas[j] = (int)out11.charAt(j);
                String out12 = dycrypt(umas);
                System.out.println(out11 + " " + out12);
                break;
            case (2):
                String name = in.nextLine();
                String start = in.nextLine();
                String end = in.nextLine();
                boolean out2 = canMove(name, start, end);
                System.out.println(out2);
                break;
            case (3):
                String STR1 = in.nextLine();
                String STR2 = in.nextLine();
                boolean out3 = canComplite(STR1, STR2);
                System.out.println(out3);
                break;
            case (4):
                int [] mas = new int [10];
                int out4 = sumDigProd(mas);
            ...
            case (5):
                ...
                for (int i = 0; i < STR.length;i++)
                    STR[i] = in.next();
                String out5 = sameVowelGroup(STR);
                System.out.println(out5);
                break;
            case (6):
                long cardNum = in.nextInt();
                boolean out6 = validateCard(cardNum);
                System.out.println(out6);
                break;
            case (7):
                int k = in.nextInt();
                String out71 = numToEng(k);
                String out72 = numToRus(k);
                System.out.printf("To English: %s, to Russian: %s ", out71, out72);
                break;
            case (8):
                String STR3 = in.nextLine();
                String out8 = getSha256Hash(STR3);
                System.out.println(out8);
                break;
            case (9):
                String title = in.nextLine();
                String out9 = correctTitle(title);
                System.out.println(out9);
                break;
            case (10):
                int x = in.nextInt();
                String out10 = haxLattice(x);

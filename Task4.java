    ...
    public static void main (String[] args) throws IOException {
        ...
        switch (n)
        {
            case (1):
                ...
                int K = in.nextInt();
                String txt = in.next();
                String out1 = Bessy(N, K, txt);
                System.out.println(out1);
                break;
            case (2):
                String str = in.nextLine();
                String [] out2 = split(str);
                System.out.println(out2);
                break;
            case (3):
                String str2 = in.nextLine();
                String out31 = toCamelCase(str2);
                String out32 = toSnakeCase(str2);
                System.out.println(out31 + ";" + out32);
                break;
            case (4):
                double [] work = new double [10];
                for (int i = 0; i < work.length;i++)
                    work[i] = in.nextInt();
                String out4 = overTime(work);
            ...
            case (7):
                ...
                String out7 = toStarShorthand(str4);
                System.out.println(out7);
                break;
            case (8):
                String STR1 = in.nextLine();
                String STR2 = in.nextLine();
                boolean out8 = doesRhyme(STR1, STR2);
                System.out.println(out8);
                break;
            case (9):
                long a = in.nextInt();
                long b = in.nextInt();
                boolean out9 = trouble(a,b);
                System.out.println(out9);
                break;
            case (10):
                String str5 = in.nextLine();
                char c = (char) System.in.read();
                int out10 = countUniqueBooks(str5, c);

    ...
    public static void main (String[] args) throws IOException {
        ...
        switch (n)
        {
            case (1):
                ...
                int K = in.nextInt();
                int M = in.nextInt();
                int out1 = solutions(N, K, M);
                System.out.println(out1);
                break;
            case (2):
                String str = in.nextLine();
                int out2 = findZip(str);
                System.out.println(out2);
                break;
            case (3):
                int number = in.nextInt();
                boolean out3 = checkPerfect(number);
                System.out.println(out3);
                break;
            case (4):
                String str1 = in.nextLine();
                String out4 = flipEndChars(str1);
                System.out.println(out4);
                break;
            case (5):
                String code = in.nextLine();
                boolean out5 = isValidHexCode(code);
            ...
            case (6):
                ...
                for (int i = 0; i < mas2.length; i++)
                    mas2[i] = in.nextInt();
                boolean out6 = same(mas1, mas2);
                System.out.println(out6);
                break;
            case (7):
                int k = in.nextInt();
                boolean out7 = isKaprekar(k);
                System.out.println(out7);
                break;
            case (8):
                String STR1 = in.nextLine();
                String out8 = longestZero(STR1);
                System.out.println(out8);
                break;
            case (9):
                int num = in.nextInt();
                int out9 = nextPrime(num);
            ...
            case (10):
                ...
                int y = in.nextInt();
                int z = in.nextInt();
                boolean out10 = rigthTriangle(x,y,z);
